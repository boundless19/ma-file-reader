...
class maFile(object):
    def __init__(self, filePath):
        ...
        #self.VRayCurrentValues = [] #list of currentValues gathered from the .ma
        #self.defaultValuesDict = [] #list of the remaining attr,
        # that are not listed in .ma, hence have the default value.
    ...
    def _queryVraySettingsNode(self):
            ...
            if readingFile[:len(stringVRaySetNode)] == stringVRaySetNode:
                ...
                while startVrayAtts == True:
                    ...
                    if readingFileNoSpaces[:len(stringAttr)] == stringAttr:
                        result = self.setAttrReader(readingFile)
        ...
        fileActive.close()
        self.VRayCurrentValues = VRayPropertyDict
        return VRayPropertyDict


    def _setAttrReader(self, varName):
        '''return the attribute alias and the value, for the given setAttr line
        inside a .ma file
        '''
        '''input : str'''
        '''output : dictionary'''
    ...
    def _checkDefault(propertyDict, categoryNo = 'CATEGORY_ALL'):
        '''checks the given propertyDict against the dictionary of full values
        and returns a list of values that are at default, hence not displayed
        '''
        ...
        self.defaultValuesDict = propertyDictDefault
        return propertyDictDefault

    def dictionaryOfValues(self):
        '''gets the current values, checks against the current values
        and returns a full list of values
        '''
        
        self._queryVraySettingsNode()
        self._checkDefault(self.VRayCurrentValues)
